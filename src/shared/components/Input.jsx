...
export const Input = React.forwardRef(({ label, error, className, icon: Icon, id, type = 'text', ...props }, ref) => {
    ...
    <div className={cn('relative w-full group', className)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            'relative w-full rounded-xl border bg-brand-black-card/80 py-3.5 text-white',
            'backdrop-blur-sm transition-all duration-300 outline-none',
            'placeholder:text-transparent focus:placeholder:text-brand-white-muted/50',
        ...
        {/* Optional Icon */}
        {Icon && (
          <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none text-brand-white-muted opacity-50">
