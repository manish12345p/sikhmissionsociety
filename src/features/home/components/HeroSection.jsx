  ...
  return (
    <section className="relative overflow-hidden bg-brand-black py-20 lg:py-32 perspective-1000">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center overflow-hidden">
        <div className="absolute top-0 -left-4 w-72 h-72 bg-brand-orange/20 rounded-full mix-blend-multiply filter blur-[100px] animate-blob" />
        <div className="absolute top-0 -right-4 w-72 h-72 bg-[#cc5200]/20 rounded-full mix-blend-multiply filter blur-[100px] animate-blob animation-delay-2000" />
